...
from ..config import (
    ...
    OLLAMA_BASE_URL, TEXT_OLLAMA_BASE_URL, VISION_OLLAMA_BASE_URL, EMBEDDING_OLLAMA_BASE_URL,
    ASSEMBLY_MODE, SIMILARITY_THRESHOLD, BATCH_SIZE, LLM_BASED_ID_ASSIGNMENT,
